      ...
      <section className="py-20 bg-gray-100 text-contrast-dark">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <a
            ...
            className="bg-apple-blue-hover text-white px-10 py-5 rounded-full text-xl font-semibold inline-flex items-center hover:bg-apple-blue-hover/80 hover:scale-105 hover:shadow-lg transition-all duration-300 shadow-md"
          >
